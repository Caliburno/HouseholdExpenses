...
public enum MovementType {
    ...
    PUBLIC_SERVICES_AND_COMMON_EXPENSES("Public Services And Common Expenses", ExpenseCategory.FIXED_EXPENSES),
    ...
    FOOD_AND_CLEANING_PRODUCTS("Food And Cleaning Products", ExpenseCategory.VARIABLE_EXPENSES),
